...
import { getAllTeamSummaries, getRealtimeReferralPoints, getTeamSummary, getUserWithReferrals , searchTreeUsers} from "../controllers/referralController.js";
...
router.post("/searchtree", searchTreeUsers);
